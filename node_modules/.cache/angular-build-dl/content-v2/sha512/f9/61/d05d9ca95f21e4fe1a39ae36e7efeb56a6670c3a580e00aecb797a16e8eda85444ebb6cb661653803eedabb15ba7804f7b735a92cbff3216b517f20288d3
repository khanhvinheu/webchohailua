...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~page-page-module~search-search-module"], {
  ...
  /***/
  function srcAppAdminServiceFilterServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var FilterService = /*#__PURE__*/function () {
      function FilterService(thongbaoService) {
      ...
      _createClass(FilterService, [{
        key: "getFilter",
        value: function getFilter(iddanhmuc) {}
      }, {
        key: "setFilter",
        value: function setFilter(items) {
    ...
    FilterService.ɵfac = function FilterService_Factory(t) {
      return new (t || FilterService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_thongbao_service__WEBPACK_IMPORTED_MODULE_2__["ThongbaoService"]));
    };
  ...
  /***/
  function srcAppPageFilterBoxFilterBoxFilterComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BoxFilterComponent", function () {
    ...
    var src_app_admin_service_danhmuc_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var src_app_admin_service_filter_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/admin/service/filter.service */
    "./src/app/admin/service/filter.service.ts");
    /* harmony import */
    ...
    var src_app_admin_service_home_page_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    function BoxFilterComponent_div_27_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function BoxFilterComponent_div_27_Template_mat_checkbox_change_1_listener($event) {
          ...
          return ctx_r3.onCheck_param($event, item_r2.id);
        });
    ...
    function BoxFilterComponent_div_36_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function BoxFilterComponent_div_36_Template_mat_checkbox_change_1_listener($event) {
          ...
          return ctx_r6.onCheckedHang_param($event, item_r5.id);
        });
    ...
    var BoxFilterComponent = /*#__PURE__*/function () {
      function BoxFilterComponent( // private sanphamService: SanphamService,
      danhmucService, activatedRoute, filterService, nhaccungcapService, router, homePageService) {
        _classCallCheck(this, BoxFilterComponent);
      ...
      _createClass(BoxFilterComponent, [{
        key: "ngOnInit",
        ...
        value: function loadData() {
          ...
          this.subscriptions.push( // this.sanphamService.currentSanpham.subscribe(data => {
          //     this.sanphams = data.slice();
          // }),
          this.homePageService.ProductObs.subscribe(function (data) {
            _this.sanphams = data.slice();
          }), this.danhmucService.itemsObs.subscribe(function (data) {
            _this.danhmucs = data;
          }), this.nhaccungcapService.itemsObs.subscribe(function (data) {
            _this.nhacungcaps = data;
          }), this.activatedRoute.queryParamMap.subscribe(function (data) {
            _this.sort1 = data['params']['sortBy'] ? data['params']['sortBy'] : null;
            _this.sort_gia = data['params']['price'] ? data['params']['price'] : null;
            _this.array_filter_hang = [];

            if (typeof data['params']['nsx'] === 'object') {
              data['params']['nsx'].forEach(function (e) {
                _this.array_filter_hang.push(e);
              });
            }

            if (typeof data['params']['nsx'] === 'string') {
              _this.array_filter_hang.push(data['params']['nsx']);
            }
          }));
        }
      }, {
        key: "onKiemTra_Hang",
        value: function onKiemTra_Hang(item) {
          if (this.array_filter_hang.length === 0) {
            return false;
          }

          return this.array_filter_hang.filter(function (e) {
            return item.id === e;
          }).length > 0 ? true : false;
        }
      }, {
        key: "getsubdanhmuc",
        value: function getsubdanhmuc(id) {
          var mang = [];
        ...
        key: "findChildDeQuy",
        value: function findChildDeQuy(id, array) {
          var _this2 = this;

          array.push(Number.parseInt(id + ''));
          this.danhmucs.forEach(function (element) {
            if (element.danhMuccha === Number.parseInt(id + '')) {
              _this2.findChildDeQuy(element.id, array);
            }
          });
        }
      }, {
        key: "findDanhMuc",
        value: function findDanhMuc(iddanhmuc) {
          if (iddanhmuc === 0) {
            return this.danhmucs.filter(function (e) {
        ...
        key: "onChangeSort_param",
        value: function onChangeSort_param() {
        ...
        key: "onCheck_param",
        value: function onCheck_param(event, id) {
          if (event.checked) {
            this.array_filter.push(id);
          } else {
            this.array_filter = this.array_filter.filter(function (e) {
              return e !== id;
            });
          }
          ...
          this.router.navigate(['/search'], {
            queryParams: {
              cat: this.array_filter
            },
            queryParamsHandling: 'merge'
          });
        }
      }, {
        key: "onCheckedHang_param",
        value: function onCheckedHang_param(event, id) {
          if (event.checked) {
            this.array_filter_hang.push(id);
            this.router.navigate(['/search'], {
              queryParams: {
                nsx: this.array_filter_hang
              },
              queryParamsHandling: 'merge'
            });
          } else {
            this.array_filter_hang = [];
            this.array_filter_hang = this.array_filter_hang.filter(function (e) {
              return e !== id;
            });
            this.router.navigate(['/search'], {
              queryParams: {
        ...
        key: "onChangeAll",
        value: function onChangeAll(event, data) {
          var _this3 = this;
        ...
        key: "onChangeSort_gia",
        value: function onChangeSort_gia() {
          this.router.navigate(['/search'], {
            queryParams: {
              price: this.sort_gia
            },
    ...
    BoxFilterComponent.ɵfac = function BoxFilterComponent_Factory(t) {
      return new (t || BoxFilterComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_admin_service_danhmuc_service__WEBPACK_IMPORTED_MODULE_1__["DanhmucService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_admin_service_filter_service__WEBPACK_IMPORTED_MODULE_3__["FilterService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_admin_service_nhacungcap_service__WEBPACK_IMPORTED_MODULE_4__["NhacungcapService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_admin_service_home_page_service__WEBPACK_IMPORTED_MODULE_5__["HomePageService"]));
    };

    BoxFilterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: BoxFilterComponent,
      selectors: [["app-box-filter"]],
      decls: 48,
      vars: 8,
      consts: [[1, "py-2"], [1, "text-danger", "font-weight-bold", 2, "font-size", "1.3rem"], [1, ""], [1, "font-weight-bolder", 2, "font-size", "1rem", "text-transform", "uppercase"], [1, "d-flex", "flex-wrap"], ["aria-label", "Select an option", "ngDefaultControl", "", 1, "text-right", 3, "ngModel", "ngModelChange", "change"], ["value", "1", 1, "col-md-6", "col-12", "m-0"], ["value", "2", 1, "col-md-6", "col-12", "m-0"], ["value", "3", 1, "col-md-6", "col-12", "m-0"], ["value", "4", 1, "col-md-6", "col-12", "m-0"], [1, "font-weight-bold", 2, "font-size", "1rem", "text-transform", "uppercase"], [1, "d-flex", "flex-wrap", "py-3", "pl-3", "box_danhmuc"], [1, "col-12", "m-0", "p-0"], [3, "ngModel", "ngModelChange", "change"], ["class", " col-md-6 col-12 m-0 p-0", 4, "ngFor", "ngForOf"], [1, "my_box_hidden", "d-none"], [1, "d-none", "d-flex", "flex-wrap", "py-3", "pl-3", "box_subdanhmuc"], [1, "d-none", "d-flex", "flex-wrap", "py-3", "pl-3", "box_subdanhmuc2"], [1, "d-flex", "flex-wrap", "p-3", "box_hang"], ["class", "form-check-inline col-md-12 col-12 m-0 p-0", 4, "ngFor", "ngForOf"], [1, "d-flex", "flex-wrap", "p-3"], ["aria-label", "Select an option", "ngDefaultControl", "", 3, "ngModel", "ngModelChange", "change"], ["value", "1", 1, "col-12", "m-0", "px-0"], ["value", "2", 1, "col-12", "m-0", "px-0"], ["value", "3", 1, "col-12", "m-0", "px-0"], [1, "col-md-6", "col-12", "m-0", "p-0"], ["type", "checkbox", 3, "value", "change"], [1, "form-check-inline", "col-md-12", "col-12", "m-0", "p-0"], ["type", "checkbox", 3, "checked", "value", "change"]],
      template: function BoxFilterComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function BoxFilterComponent_Template_mat_radio_group_ngModelChange_10_listener($event) {
            return ctx.sort1 = $event;
          })("change", function BoxFilterComponent_Template_mat_radio_group_change_10_listener() {
            return ctx.onChangeSort_param();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function BoxFilterComponent_Template_mat_checkbox_ngModelChange_25_listener($event) {
            return ctx.checked = $event;
          })("change", function BoxFilterComponent_Template_mat_checkbox_change_25_listener($event) {
            return ctx.onChangeAll($event, ctx.findDanhMuc(0));
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](34, "Ch\u1ECDn nh\xE0 cung c\u1EA5p");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](39, "Ch\u1ECDn m\u1EE9c gi\xE1");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function BoxFilterComponent_Template_mat_radio_group_ngModelChange_41_listener($event) {
            return ctx.sort_gia = $event;
          })("change", function BoxFilterComponent_Template_mat_radio_group_change_41_listener() {
            return ctx.onChangeSort_gia();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](47, "Tr\xEAn 3 tri\u1EC7u");
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](3, 6, "B\u1ED9 L\u1ECDc T\xECm Ki\u1EBFm "));
      ...
      directives: [_angular_material_radio__WEBPACK_IMPORTED_MODULE_6__["MatRadioGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["NgModel"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_6__["MatRadioButton"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_8__["MatCheckbox"], _angular_common__WEBPACK_IMPORTED_MODULE_9__["NgForOf"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BoxFilterComponent, [{
        ...
        return [{
          type: src_app_admin_service_danhmuc_service__WEBPACK_IMPORTED_MODULE_1__["DanhmucService"]
        }, {
          type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]
        }, {
          type: src_app_admin_service_filter_service__WEBPACK_IMPORTED_MODULE_3__["FilterService"]
        }, {
          type: src_app_admin_service_nhacungcap_service__WEBPACK_IMPORTED_MODULE_4__["NhacungcapService"]
        }, {
          type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]
        }, {
          type: src_app_admin_service_home_page_service__WEBPACK_IMPORTED_MODULE_5__["HomePageService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppPageSearchSearchComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_models_cart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/models/cart */
    ...
    var src_app_environments_environment_prod__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/environments/environment.prod */
    "./src/app/environments/environment.prod.ts");
    /* harmony import */


    var src_app_admin_service_cart_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/admin/service/cart.service */
    "./src/app/admin/service/cart.service.ts");
    /* harmony import */


    var src_app_admin_service_danhmuc_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/admin/service/danhmuc.service */
    "./src/app/admin/service/danhmuc.service.ts");
    /* harmony import */
    ...
    var src_app_admin_service_filter_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! src/app/admin/service/filter.service */
    "./src/app/admin/service/filter.service.ts");
    /* harmony import */


    var src_app_admin_service_other_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! src/app/admin/service/other.service */
    "./src/app/admin/service/other.service.ts");
    /* harmony import */


    var src_app_admin_service_home_page_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! src/app/admin/service/home-page.service */
    "./src/app/admin/service/home-page.service.ts");
    /* harmony import */


    var src_app_admin_service_thongbao_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    var _filter_box_filter_box_filter_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ../filter/box-filter/box-filter.component */
    "./src/app/page/filter/box-filter/box-filter.component.ts");
    /* harmony import */
    ...
    function SearchComponent_div_15_div_1_ng_container_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SearchComponent_div_15_div_1_ng_template_10_ng_container_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    function SearchComponent_div_15_div_1_ng_template_10_ng_template_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SearchComponent_div_15_div_1_ng_template_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SearchComponent_div_15_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SearchComponent_div_15_div_1_Template_button_click_16_listener() {
          ...
          return ctx_r11.onAddCart(item_r2);
        });
    ...
    var _c2 = function _c2() {
      return [5, 10, 20, 32, 40];
    };

    var SearchComponent = /*#__PURE__*/function () {
      function SearchComponent(cartService, danhmucService, activatedRoute, filterService, otherService, homepageService, thongbaoService) {
        ...
        this.productall = [];
        this.sanphams = [];
        this.danhmucs = []; //chitietHDNs: ChiTietHoaDonNhap[] = [];
      ...
      _createClass(SearchComponent, [{
        ...
        key: "findChildDeQuy_danhmuc",
        value: function findChildDeQuy_danhmuc(id, array) {
          var _this4 = this;

          array.push(Number.parseInt(id + ''));
          this.danhmucs.forEach(function (element) {
            if (element.danhMuccha === Number.parseInt(id + '')) {
              _this4.findChildDeQuy_danhmuc(element.id, array);
            }
          });
        }
      }, {
        key: "myFilter",
        value: function myFilter(items) {
          var _this5 = this;

          if (this.my_array.length !== 0) {
            items = items.filter(function (e) {
              return _this5.my_array.filter(function (i) {
                return Number.parseInt(e.idDanhMuc + '') === Number.parseInt(i + '');
              }).length > 0;
            });
          }

          if (typeof this.nsx !== 'undefined' && this.nsx !== [] && this.nsx !== undefined) {
            if (this.nsx.length > 0) {
              items = items.filter(function (e) {
                return _this5.nsx.filter(function (i) {
                  return Number.parseInt(i + '') === Number.parseInt(e.idNhacungcap + '');
                }).length > 0;
              });
            }
          }
          ...
          if (this.keyword !== '' && this.keyword !== undefined) {
            items = items.filter(function (e) {
              return _this5.cleanAccents(e.tenSanpham.trim().toLowerCase()).includes(_this5.cleanAccents(_this5.keyword));
            });
          }
        ...
        value: function loadData() {
          ...
          this.subscriptions.push(this.homepageService.ProductObs.subscribe(function (data) {
            _this6.productall = data.slice();

            _this6.load_array();

            _this6.products = _this6.myFilter(_this6.productall.slice());
            _this6.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](_this6.products);
            _this6.dataSource.paginator = _this6.paginator;
            _this6.obs = _this6.dataSource.connect();

            if (_this6.obs['value'].length > 0) {
              _this6.isShow = true;
            }
          }), this.danhmucService.itemsObs.subscribe(function (data) {
            _this6.danhmucs = data;
          ...
          this.activatedRoute.queryParamMap.subscribe(function (data) {
            ...
            if (typeof data['params']['keyword'] === 'string') {
              _this6.keyword = data['params']['keyword'];
            }

            if (typeof data['params']['sortBy'] === 'string') {
              _this6.sortby = data['params']['sortBy'];
            }

            if (typeof data['params']['cat'] === 'string') {
              _this6.cat.push(data['params']['cat']);
            } else {
              if (typeof data['params']['cat'] === 'object') {
                data['params']['cat'].map(function (e) {
                  _this6.cat.push(e);
                });
              }
            }
            ...
            if (typeof data['params']['nsx'] === 'string') {
              _this6.nsx.push(data['params']['nsx']);
            } else {
              if (typeof data['params']['nsx'] === 'object') {
                data['params']['nsx'].map(function (e) {
                  _this6.nsx.push(e);
                });
              }
            }
            ...
            if (typeof data['params']['price'] === 'string') {
              _this6.price = Number.parseInt(data['params']['price']);
            }

            _this6.load_array();

            _this6.products = _this6.myFilter(_this6.productall.slice());
            _this6.dataSource.data = _this6.products;
          }));
        }
      }, {
        key: "load_array",
        value: function load_array() {
          var _this7 = this;

          if (this.cat !== undefined) {
            this.my_array = [];
            this.cat.forEach(function (e) {
              _this7.findChildDeQuy_danhmuc(Number.parseInt(e), _this7.my_array);
            });
          }
        }
      }, {
    ...
    SearchComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function SearchComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "T\xECm ki\u1EBFm");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SearchComponent_Template_div_click_11_listener() {
      ...
      directives: [_angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterLinkWithHref"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterLinkActive"], _angular_material_button__WEBPACK_IMPORTED_MODULE_12__["MatButton"], _angular_common__WEBPACK_IMPORTED_MODULE_13__["NgIf"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_3__["MatPaginator"], _filter_box_filter_box_filter_component__WEBPACK_IMPORTED_MODULE_14__["BoxFilterComponent"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_15__["MatSidenavContainer"], _angular_common__WEBPACK_IMPORTED_MODULE_13__["NgForOf"]],
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_13__["TitleCasePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_13__["CurrencyPipe"], _angular_common__WEBPACK_IMPORTED_MODULE_13__["DecimalPipe"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SearchComponent, [{
        ...
        return [{
          type: src_app_admin_service_cart_service__WEBPACK_IMPORTED_MODULE_5__["CartService"]
        }, {
          type: src_app_admin_service_danhmuc_service__WEBPACK_IMPORTED_MODULE_6__["DanhmucService"]
        }, {
          type: _angular_router__WEBPACK_IMPORTED_MODULE_7__["ActivatedRoute"]
        }, {
          type: src_app_admin_service_filter_service__WEBPACK_IMPORTED_MODULE_8__["FilterService"]
        }, {
          type: src_app_admin_service_other_service__WEBPACK_IMPORTED_MODULE_9__["OtherService"]
        }, {
          type: src_app_admin_service_home_page_service__WEBPACK_IMPORTED_MODULE_10__["HomePageService"]
        }, {
          type: src_app_admin_service_thongbao_service__WEBPACK_IMPORTED_MODULE_11__["ThongbaoService"]
        }];
      }, {
        paginator: [{
  ...
  /***/
  function srcAppPageSearchSearchModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_share_share_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var _filter_box_filter_box_filter_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../filter/box-filter/box-filter.component */
    "./src/app/page/filter/box-filter/box-filter.component.ts");
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SearchModule, {
        declarations: [_search_component__WEBPACK_IMPORTED_MODULE_1__["SearchComponent"], _filter_box_filter_box_filter_component__WEBPACK_IMPORTED_MODULE_5__["BoxFilterComponent"]],
        imports: [src_app_share_share_module__WEBPACK_IMPORTED_MODULE_2__["ShareModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"], ngx_slick_carousel__WEBPACK_IMPORTED_MODULE_3__["SlickCarouselModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"]],
        exports: [_search_component__WEBPACK_IMPORTED_MODULE_1__["SearchComponent"], _filter_box_filter_box_filter_component__WEBPACK_IMPORTED_MODULE_5__["BoxFilterComponent"]]
      });
    })();
    /*@__PURE__*/
...
//# sourceMappingURL=default~page-page-module~search-search-module-es5.js.map